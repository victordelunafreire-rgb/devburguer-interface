  ...
  return (
    <div className='container'>
      <div id='payment-status'>
        ...
        <h2 className='status-title' id='status-text'>
        ...
        {status === 'succeeded' ? (
          <Link id='retry-button' to='/'>
            Voltar para a Home
          </Link>
        ) : (
          <Link id='retry-button' to='/checkout'>
            Tente novamente
          </Link>
        )}
      </div>
